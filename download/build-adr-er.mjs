...
const entities = [
  ...
  {
    id: 'TB_CADASTROFUNCIONARIOFOL_OCUP',
    x: 40,
    y: 280,
    name: 'TB_CADASTROFUNCIONARIOFOL_OCUP (EXISTENTE)',
    color: C_GREEN,
    columns: [
      { key: 'PK', name: 'FUNCIONARIO_ID', type: 'NUMBER' },
      { key: '', name: 'EMPRESA_ID', type: 'NUMBER' },
      { key: '', name: 'CPF', type: 'VARCHAR2(11)' },
    ],
  },
  {
    id: 'TB_CADASTROEMPRESA_OCUP',
    x: 480,
    y: 540,
    name: 'TB_CADASTROEMPRESA_OCUP (EXISTENTE)',
    color: C_GREEN,
    columns: [
      { key: 'PK', name: 'EMPRESA_ID', type: 'NUMBER' },
    ],
  },
  {
    id: 'TB_DOC_SYNC_JOB',
  ...
  },
  {
    ...
    columns: [
      { key: 'PK', name: 'ID', type: 'NUMBER' },
      { key: 'FK', name: 'EMPRESA_ID', type: 'NUMBER' },
      { key: 'FK', name: 'TIPO_DOC_ID', type: 'NUMBER' },
      { key: 'FK', name: 'FUNCIONARIO_ID', type: 'NUMBER' },
...
const relCells = [
  ...
  rel({ id: 'r2', source: 'TB_CADASTROFUNCIONARIOFOL_OCUP', target: 'TB_DOC_PREV_CONTROLE', label: '0..1 : N  vincula (FUNCIONARIO_ID)', sourceMul: 'ERzeroToOne', targetMul: 'ERmany' }),
  rel({ id: 'r3', source: 'TB_CADASTROEMPRESA_OCUP', target: 'TB_DOC_PREV_CONTROLE', label: '1 : N  pertence', sourceMul: 'ERone', targetMul: 'ERmany' }),
  rel({ id: 'r4', source: 'TB_DOC_PREV_CONTROLE', target: 'TB_DOC_AUDITORIA', label: '1 : N  auditado por', sourceMul: 'ERone', targetMul: 'ERmany' }),
  rel({ id: 'r5', source: 'TB_DOC_SYNC_JOB', target: 'TB_DOC_PREV_CONTROLE', label: '1 : N  sincronizou', sourceMul: 'ERone', targetMul: 'ERmany' }),
].join('\n        ');
...
const legendCell = `<mxCell id="legend" value="&lt;b&gt;Legenda&lt;/b&gt;&lt;br/&gt;PK = Primary Key&lt;br/&gt;FK = Foreign Key&lt;br/&gt;⚠ = Pendência (mapeamento SOC)&lt;br/&gt;(EXISTENTE) = Tabela já existente no Oracle (não criar)&lt;br/&gt;&lt;br/&gt;&lt;b&gt;Decisões&lt;/b&gt;&lt;br/&gt;• Histórico imutável: chave única (EMPRESA_ID, TIPO_DOC_ID, FUNCIONARIO_ID, VERSAO, ESCOPO_REGISTRO)&lt;br/&gt;• FUNCIONARIO_ID nullable (escopo Empresa)&lt;br/&gt;• SYNC_STATUS: OK | STALE | PENDING&lt;br/&gt;• Binários no GCS, apenas chave no Oracle&lt;br/&gt;• Reaproveitamento de TB_CADASTROFUNCIONARIOFOL_OCUP e TB_CADASTROEMPRESA_OCUP" style="text;html=1;align=left;verticalAlign=top;whiteSpace=wrap;fillColor=#F5F5F5;strokeColor=#999;fontSize=10;spacingLeft=8;spacingTop=6;" vertex="1" parent="1">
    <mxGeometry x="40" y="540" width="380" height="180" as="geometry"/>
  </mxCell>`;

const xml = `<mxfile host="claude" type="device">
  <diagram id="er" name="ER">
    <mxGraphModel dx="1400" dy="900" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1400" pageHeight="780" math="0" shadow="0">
      <root>
        <mxCell id="0"/>
