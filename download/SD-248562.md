...
| # | Documento | Empresa | Funcionário |
|---|---|:---:|:---:|
| 1 | AEP — Avaliação Ergonômica Preliminar | ✓ | |
| 2 | AET — Análise Ergonômica | ✓ | |
| 3 | Dosimetria de Ruído | ✓ | |
| 4 | PPP — Perfil Profissiográfico Previdenciário | | ✓ |
| 5 | Laudo de Insalubridade — NR 15 | ✓ | ✓ |
| 6 | Laudo de Periculosidade — NR 16 | ✓ | ✓ |
| 7 | LTCAT — Laudo Técnico Condições Ambiente Trabalho | ✓ | ✓ |
| 8 | NR-01 Ordem de Serviço | | ✓ |
| 9 | NR-05 Acompanhamento CIPA / Ata Reunião Mensal | ✓ | |
| 10 | NR-05 Implantação CIPA / ATA Instalação e Posse | ✓ | |
| 11 | NR-05 Mapa de Risco | ✓ | |
| 12 | NR-05 Treinamento CIPA / Certificados | ✓ | ✓ |
| 13 | NR-05 Designado CIPA / Carta Designação | ✓ | |
| 14 | NR-05 Treinamento Designado CIPA | ✓ | ✓ |
| 15 | NR-06 Treinamento EPI | ✓ | ✓ |
| 16 | Treinamento Anexo II NR-17 / Certificados | ✓ | ✓ |
| 17 | Treinamento Ergonomia em Home Office | ✓ | |
...
**Fluxo de sincronização (batch diário):** Worker → SOC → `careplus.infra-service-client` → GCS + Oracle.
...
| Integração externa | SOC WebService (SOAP/REST) |
...
| **Worker Sync** | Job diário agendado (Cloud Scheduler + Cloud Run Job). Consome SOC Web Service, persiste metadados no Oracle e binários no GCS. Mantém `DOC_SYNC_JOB` |
